...
Only requiring some minor changes is eternity.cpp.
...
Changes to eternity.cpp
----------------------
eternity.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 ENT, node2 has none. 
#   d) node0 sends 21 ENT to node2, in two transactions (11 ENT, then 10 ENT).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 ENT from 0 to 2 using sendtoaddress call.

...
// fConnectToEternitynode should be 'true' only if you want this node to allow to connect to itself
// and/or you want it to be disconnected on CEternitynodeMan::ProcessEternitynodeConnections()
CNode* ConnectNode(CAddress addrConnect, const char *pszDest = NULL, bool fConnectToEternitynode = false);
...
public:
    ...
    bool fRelayTxes;
    // If 'true' this node will be disconnected on CEternitynodeMan::ProcessEternitynodeConnections()
    bool fEternitynode;
    CSemaphoreGrant grantOutbound;
    CSemaphoreGrant grantEternitynodeOutbound;

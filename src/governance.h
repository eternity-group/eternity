...
private:
    ...
    object_time_m_t mapEternitynodeOrphanObjects;
    ...
    txout_m_t mapLastEternitynodeObject;
...
public:
    ...
    void Clear()
    {
        ...
        mapLastEternitynodeObject.clear();
    }
    ...
    inline void SerializationOp(Stream& s, Operation ser_action, int nType, int nVersion) {
        ...
        READWRITE(mapLastEternitynodeObject);
    ...
    bool EternitynodeRateCheck(const CGovernanceObject& govobj, update_mode_enum_t eUpdateLast = UPDATE_FALSE);

    bool EternitynodeRateCheck(const CGovernanceObject& govobj, update_mode_enum_t eUpdateLast, bool fForce, bool& fRateCheckBypassed);
    ...
    void CheckEternitynodeOrphanVotes();

    void CheckEternitynodeOrphanObjects();
...
private:
    ...
    int GetEternitynodeIndex(const CTxIn& eternitynodeVin);

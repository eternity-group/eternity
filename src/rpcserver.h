...
/**
 * Eternity RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value eternitynode(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value eternitynodelist(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value eternitynodebroadcast(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value enevolution(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value enevolutionvoteraw(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value mnfinalevolution(const json_spirit::Array& params, bool fHelp);

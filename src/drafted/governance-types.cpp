...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EternityNetwork") type = EternityNetwork;
    if(strType == "EternityNetworkVariable") type = EternityNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EternityNetwork) s = "EternityNetwork";
    if(type == EternityNetworkVariable) s = "EternityNetworkVariable";

...
// Copyright (c) 2016 The Eternity Core developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:4855", "127.0.0.1", 4855));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4855", "127.0.0.1", 4855));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4855", "::ffff:127.0.0.1", 4855));
    BOOST_CHECK(TestSplitHost("[::]:4855", "::", 4855));

...
extern const char *ETERNITYNODEPAYMENTVOTE;
extern const char *ETERNITYNODEPAYMENTSYNC;
...
enum {
    ...
    // set by all Eternity Core nodes, and is unset by SPV clients or other peers that just want
    // network services but don't provide them.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // Eternity Core does not support this but a patch set called Bitcoin XT does.
    // See BIP 64 for details on how this is implemented.
    NODE_GETUTXO = (1 << 1),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Eternity Core nodes used to support this by default, without advertising this bit,
...
enum {
    ...
    MSG_TXLOCK_VOTE,
    MSG_SPORK,
    MSG_ETERNITYNODE_PAYMENT_VOTE,
    MSG_ETERNITYNODE_PAYMENT_BLOCK, // reusing, was MSG_ETERNITYNODE_SCANNING_ERROR previousely, was NOT used in 12.0
    ...
    MSG_ETERNITYNODE_QUORUM, // not implemented
    MSG_ETERNITYNODE_ANNOUNCE,
    MSG_ETERNITYNODE_PING,
    MSG_DSTX,
    MSG_GOVERNANCE_OBJECT,
    MSG_GOVERNANCE_OBJECT_VOTE,
    MSG_ETERNITYNODE_VERIFY,
};

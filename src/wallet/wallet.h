...
enum AvailableCoinsType
{
    ...
    ONLY_1000 = 5, // find eternitynode outputs including locked ones (use with caution)
    ONLY_SPYSEND_COLLATERAL = 6
};
...
public:
    ...
    /// Get 1000ENT output and keys which can be used for the Eternitynode
    bool GetEternitynodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");

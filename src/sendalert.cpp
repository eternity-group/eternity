...
2. run eternityd with -printalert or -sendalert like this:
   /path/to/eternityd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.eternity-group.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Eternity Core:0.12.0.58/"));

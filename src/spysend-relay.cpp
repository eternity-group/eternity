...
CSpySendRelay::CSpySendRelay(CTxIn& vinEternitynodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
...
std::string CSpySendRelay::ToString()
{
    ...
    info << "vin: " << vinEternitynode.ToString() <<

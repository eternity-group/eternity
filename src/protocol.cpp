...
const char *ETERNITYNODEPAYMENTVOTE="mnw";
const char *ETERNITYNODEPAYMENTBLOCK="mnwb";
const char *ETERNITYNODEPAYMENTSYNC="mnget";
...
static const char* ppszTypeName[] =
{
    ...
    NetMsgType::SPORK,
    NetMsgType::ETERNITYNODEPAYMENTVOTE,
    NetMsgType::ETERNITYNODEPAYMENTBLOCK, // reusing, was MNSCANERROR previousely, was NOT used in 12.0, we need this for inv
...
const static std::string allNetMessageTypes[] = {
    ...
    NetMsgType::ETERNITYNODEPAYMENTVOTE,
    // NetMsgType::ETERNITYNODEPAYMENTBLOCK, // there is no message for this, only inventory
    NetMsgType::ETERNITYNODEPAYMENTSYNC,
    NetMsgType::MNANNOUNCE,
    NetMsgType::MNPING,
    NetMsgType::DSACCEPT,
    NetMsgType::DSVIN,

...
const char * const BITCOIN_CONF_FILENAME = "eternity.conf";
const char * const BITCOIN_PID_FILENAME = "eternityd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\EternityCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\EternityCore
    // Mac: ~/Library/Application Support/EternityCore
    // Unix: ~/.eternitycore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "EternityCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/EternityCore";
#else
    // Unix
    return pathRet / ".eternitycore";
#endif
#endif
}

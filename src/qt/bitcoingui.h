...
private Q_SLOTS:
    ...
    /** Switch to eternitynode page */
    void gotoEternitynodePage();
    ...
    /** Open external (default) editor with eternity.conf */
    void showConfEditor();
    /** Open external (default) editor with eternitynode.conf */

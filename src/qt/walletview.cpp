    ...
    platformStyle(platformStyle)
{
    ...
    if (settings.value("fShowEternitynodesTab").toBool()) {
        eternitynodeListPage = new EternitynodeList(platformStyle);
        addWidget(eternitynodeListPage);
    }
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowEternitynodesTab").toBool()) {
        eternitynodeListPage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowEternitynodesTab").toBool()) {
        eternitynodeListPage->setWalletModel(walletModel);
    }
...
void WalletView::gotoEternitynodePage()
{
    QSettings settings;
    if (settings.value("fShowEternitynodesTab").toBool()) {
        setCurrentWidget(eternitynodeListPage);
    }
}

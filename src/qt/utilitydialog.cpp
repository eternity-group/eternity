    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Eternity Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Eternity Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  eternity-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Eternity in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ENT, 0.1 ENT, 1 ENT and 10 ENT -- sort of like the paper money you use every day.</li> \
<li>Your wallet then sends requests to specially configured software nodes on the network, called \"eternitynodes.\" \
These eternitynodes are informed then that you are interested in mixing a certain denomination. \
No identifiable information is sent to the eternitynodes, so they never know \"who\" you are.</li> \
...
The eternitynode mixes up the inputs and instructs all three users' wallets to pay the now-transformed input back to themselves. \
...
For more info see <a href=\"https://eternitypay.atlassian.net/wiki/display/DOC/SpySend\">https://eternitypay.atlassian.net/wiki/display/DOC/SpySend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Eternity Core is shutting down...") + "<br /><br />" +

...
QT_TRANSLATE_NOOP("eternity-core", ""
"Disable all Eternity specific functionality (Eternitynodes, SpySend, "
...
"default: %u)"),
QT_TRANSLATE_NOOP("eternity-core", ""
"Enable multiple SpySend mixing sessions per block, experimental (0-1, "
"default: %u)"),
QT_TRANSLATE_NOOP("eternity-core", ""
...
"is wrong Eternity Core will not work properly."),
QT_TRANSLATE_NOOP("eternity-core", ""
"SpySend uses exact denominated amounts to send funds, you might simply "
...
QT_TRANSLATE_NOOP("eternity-core", ""
"Unable to locate enough SpySend non-denominated funds for this "
"transaction that are not equal 1000 ENT."),
QT_TRANSLATE_NOOP("eternity-core", ""
...
QT_TRANSLATE_NOOP("eternity-core", ""
"Use N separate eternitynodes for each denominated input to mix funds (2-16, "
"default: %u)"),
QT_TRANSLATE_NOOP("eternity-core", ""
...
QT_TRANSLATE_NOOP("eternity-core", ""
"eternitynodeaddr option is deprecated. Please use eternitynode.conf to manage "
"your remote eternitynodes."),
QT_TRANSLATE_NOOP("eternity-core", "%s - %d confirmations"),
QT_TRANSLATE_NOOP("eternity-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("eternity-core", "(default: %s)"),
QT_TRANSLATE_NOOP("eternity-core", "(default: %u)"),
QT_TRANSLATE_NOOP("eternity-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("eternity-core", "-maxmempool must be at least %d MB"),
...
QT_TRANSLATE_NOOP("eternity-core", "Activating best chain..."),
...
QT_TRANSLATE_NOOP("eternity-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("eternity-core", "Attempt to recover private keys from a corrupt wallet.dat on startup"),
QT_TRANSLATE_NOOP("eternity-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("eternity-core", "Automatically create Tor hidden service (default: %d)"),
...
QT_TRANSLATE_NOOP("eternity-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("eternity-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("eternity-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("eternity-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("eternity-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("eternity-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("eternity-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("eternity-core", "Enable the client to act as a eternitynode (0-1, default: %u)"),
QT_TRANSLATE_NOOP("eternity-core", "Enable transaction replacement in the memory pool (default: %u)"),
...
QT_TRANSLATE_NOOP("eternity-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("eternity-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("eternity-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("eternity-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("eternity-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("eternity-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("eternity-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("eternity-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("eternity-core", "Imports blocks from external blk000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("eternity-core", "InstantSend options:"),
...
QT_TRANSLATE_NOOP("eternity-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("eternity-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
...
QT_TRANSLATE_NOOP("eternity-core", "Loading fullfiled requests cache..."),
QT_TRANSLATE_NOOP("eternity-core", "Loading governance cache..."),
...
QT_TRANSLATE_NOOP("eternity-core", "Location of the auth cookie (default: data dir)"),
...
QT_TRANSLATE_NOOP("eternity-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("eternity-core", "Eternitynode cache is empty, skipping payments and governance cache..."),
...
QT_TRANSLATE_NOOP("eternity-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
...
QT_TRANSLATE_NOOP("eternity-core", "No errors detected."),
...
QT_TRANSLATE_NOOP("eternity-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("eternity-core", "Not in the Eternitynode list."),
QT_TRANSLATE_NOOP("eternity-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("eternity-core", "Port: %d"),
QT_TRANSLATE_NOOP("eternity-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("eternity-core", "Print version and exit"),
...
QT_TRANSLATE_NOOP("eternity-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("eternity-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("eternity-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("eternity-core", "RPC server options:"),
QT_TRANSLATE_NOOP("eternity-core", "Rebuild block chain index from current blk000??.dat files on startup"),
QT_TRANSLATE_NOOP("eternity-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("eternity-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("eternity-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("eternity-core", "Send trace/debug info to console instead of debug.log file"),
...
QT_TRANSLATE_NOOP("eternity-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("eternity-core", "Synchronizing eternitynode payments..."),
QT_TRANSLATE_NOOP("eternity-core", "Synchronizing eternitynodes..."),
QT_TRANSLATE_NOOP("eternity-core", "Synchronizing sporks..."),
QT_TRANSLATE_NOOP("eternity-core", "The transaction amount is too small to pay the fee"),
...
QT_TRANSLATE_NOOP("eternity-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("eternity-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("eternity-core", "Tor control port to use if onion listening enabled (default: %s)"),
...
QT_TRANSLATE_NOOP("eternity-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("eternity-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("eternity-core", "Unknown response."),
QT_TRANSLATE_NOOP("eternity-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("eternity-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("eternity-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("eternity-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("eternity-core", "Upgrade wallet to latest format on startup"),
...
QT_TRANSLATE_NOOP("eternity-core", "User Agent comment (%s) contains unsafe characters."),
...
QT_TRANSLATE_NOOP("eternity-core", "Very low number of keys left: %d"),
...
QT_TRANSLATE_NOOP("eternity-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("eternity-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("eternity-core", "Whether to operate in a blocks only mode (default: %u)"),
...
QT_TRANSLATE_NOOP("eternity-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("eternity-core", "no mixing available."),
QT_TRANSLATE_NOOP("eternity-core", "see debug.log for details."),

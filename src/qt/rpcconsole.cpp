...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        setEternitynodeCount(model->getEternitynodeCountString());
        connect(model, SIGNAL(strEternitynodesChanged(QString)), this, SLOT(setEternitynodeCount(QString)));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Eternity Core RPC console.") + "<br>" +
...
void RPCConsole::setEternitynodeCount(const QString &strEternitynodes)
{
    ui->eternitynodeCount->setText(strEternitynodes);
}

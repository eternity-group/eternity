...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Eternity Core"),
     ...
     * override -datadir in the eternity.conf file in the default data directory
     * (to be consistent with eternityd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
